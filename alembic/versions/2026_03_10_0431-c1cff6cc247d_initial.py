...
Revision ID: c1cff6cc247d
Revises: 
Create Date: 2026-03-10 04:31:51.425467+00:00
...
def upgrade() -> None:
    ...
    sa.Column('phone_number', sa.String(length=16), nullable=False, comment='Номер телефона'),
